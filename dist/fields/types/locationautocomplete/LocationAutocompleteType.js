...
const addressComponents = ['street_name', 'street_number', 'sublocality', 'locality', 'state', 'postal_code', 'country', 'place_id', 'geo', 'formatted'];
...
locationautocomplete.prototype.addFilterToQuery = function (filter) {
	var query = {};
	var field = this;
	var filterPathMap = ['street_name', 'sublocality', 'locality', 'state', 'postal_code'];
...
locationautocomplete.prototype.isModified = function (item) {
	return item.isModified(this.paths.number) || item.isModified(this.paths.name) || item.isModified(this.paths.street) || item.isModified(this.paths.suburb) || item.isModified(this.paths.state) || item.isModified(this.paths.postal_code) || item.isModified(this.paths.country) || item.isModified(this.paths.geo);
};
