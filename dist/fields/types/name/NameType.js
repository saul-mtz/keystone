...
name.prototype.validateInput = function (data, callback) {
	...
	var result = value === undefined || value === null || typeof value === 'string' || typeof value === 'object' && (typeof value.first === 'string' || value.first === null || typeof value.last === 'string' || value.last === null);
...
name.prototype.validateRequiredInput = function (item, data, callback) {
	...
	if (value === null) {
		...
		result = typeof value === 'string' && value.length || typeof value === 'object' && (typeof value.first === 'string' && value.first.length || typeof value.last === 'string' && value.last.length) || (item.get(this.paths.full) || item.get(this.paths.first) || item.get(this.paths.last)) && (value === undefined || value.first === undefined && value.last === undefined) ? true : false;
	}
	utils.defer(callback, result);
};
