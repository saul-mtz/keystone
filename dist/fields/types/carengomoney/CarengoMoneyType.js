...
carengomoney.prototype.getRangeErrorMessage = function (minCents, maxCents) {
	const { forceInteger } = this.options;
	const min = (0, _lib.format)(minCents, { forceInteger, currency, locale });
	const max = (0, _lib.format)(maxCents, { forceInteger, currency, locale });
...
carengomoney.prototype.format = function (item) {
	...
	return (0, _lib.format)(value, formatOptions);
};
