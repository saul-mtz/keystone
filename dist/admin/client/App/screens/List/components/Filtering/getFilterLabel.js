...
function resolveDateFormat(value, format, conjunction = 'is') {
	...
	const formattedValue = value.mode === 'between' ? `${(0, _moment2.default)(value.after).format(format)} and ${(0, _moment2.default)(value.before).format(format)}` : (0, _moment2.default)(value.value).format(format);
