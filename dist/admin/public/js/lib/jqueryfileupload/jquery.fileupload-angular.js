...
(function (factory) {
            ...
            add: function (e, data) {
                ...
                data.process(function () {
                    ...
                    scope.$apply(function () {
                        ...
                        if (file.$submit && (scope.option('autoUpload') || data.autoUpload) && data.autoUpload !== false) {
                            file.$submit();
                        }
                    });
                });
    ...
    .controller('FileUploadPreviewController', ['$scope', '$element', '$attrs', '$parse', function ($scope, $element, $attrs, $parse) {
